      ...
      if (req.url.includes('/history/period')) {
        ...
        proxyRes.on('end', () => {
          try {
            ...
            // Send the decompressed response directly
...
app.get('/api/env-config', (req, res) => {
  res.json({
    ...
    quadName: process.env.QUAD_NAME || 'Bedroom',
    quintName: process.env.QUINT_NAME || 'Servers',
    entities: {
      ...
      temperatureQuad: process.env.ENTITY_TEMP_QUAD || '',
      temperatureQuadTrend: process.env.ENTITY_TEMP_QUAD_TREND || '',
      humidityQuad: process.env.ENTITY_HUMIDITY_QUAD || '',
      co2Quad: process.env.ENTITY_CO2_QUAD || '',
      temperatureQuint: process.env.ENTITY_TEMP_QUINT || '',
      temperatureQuintTrend: process.env.ENTITY_TEMP_QUINT_TREND || '',
      humidityQuint: process.env.ENTITY_HUMIDITY_QUINT || '',
      co2Quint: process.env.ENTITY_CO2_QUINT || '',
